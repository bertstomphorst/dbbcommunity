...
class ResCompany(models.Model):
    ...
    bcc_emails = fields.Char("BCC Email's")
...
class MailMail(models.Model):
    ...
    #     string='BCC',
    #     help='BCC(Black Carbon Copy) message recipients')
    ...
    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None, alias_domain_id=False):
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                # # send each sub-email
                # bcc_emails = ''
                # if self.env.user.company_id.bcc_emails:
                #     bcc_emails = self.env.user.company_id.bcc_emails
                bcc_emails = email_from
                ...
                for email in email_list:
                    ...
                    bcc_current = ''
                    if email['subject'] not in bcc_mail_subjects_done:
                        bcc_current = bcc_emails
                        bcc_mail_subjects_done.append(email['subject'])
                    ...
                    msg = SendIrMailServer.build_email(
                        ...
                        email_bcc=tools.email_split(bcc_current),
